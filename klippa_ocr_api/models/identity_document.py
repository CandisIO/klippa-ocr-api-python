...
class IdentityDocument(object):
    ...
    def __init__(self, date_of_birth=None, date_of_expiry=None, date_of_issue=None, document_number=None, document_subtype=None, document_type=None, face=None, gender=None, given_names=None, height=None, identity_document=None, issuing_country=None, issuing_institution=None, nationality=None, personal_number=None, place_of_birth=None, residency=None, signature=None, surname=None, local_vars_configuration=None):  # noqa: E501
