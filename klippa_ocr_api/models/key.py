...
class Key(object):
    ...
    def __init__(self, created_at=None, credit_system=None, data_collection=None, deleted_at=None, id=None, key=None, name=None, parent_key_id=None, public_keys=None, status=None, sub_keys=None, templates=None, updated_at=None, user_data_sets=None, local_vars_configuration=None):  # noqa: E501
